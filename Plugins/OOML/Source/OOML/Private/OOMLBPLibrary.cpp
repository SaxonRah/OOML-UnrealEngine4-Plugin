...
UOOMLBPLibrary::UOOMLBPLibrary(const FObjectInitializer& ObjectInitializer)
: Super(ObjectInitializer)
{

}

int UOOMLBPLibrary::OOMLSampleFunction(FString Param)
{
	...
	FDynamicMeshOBJReader::Read(TCHAR_TO_UTF8(*Param), ImportMesh, true, true, true);
	...
	FDynamicMeshOBJWriter::Write(TCHAR_TO_UTF8(*Param),
